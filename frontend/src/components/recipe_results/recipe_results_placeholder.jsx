  ...
  return (
    <div className='results placeholder'>
      ...
      <ol>
        ...
        <li>Select ingredients from your digital fridge</li>
        <li>Once you have your food combination, hit <span id='recipes'>GET RECIPES</span></li>
      </ol>
      <br />
      <br />
      <br />
...
export default RecipeResultsPlaceholder;
